...
file1      = '%s/DADOS/lasso_sam_lsf_20150606/raw_model/sgp20150606_alpha1r.varanal_300km_25mb_ls.varanal_300km_25mb_sf.sonde_init.144.nc'%(computer)
f060615    =  var_l.ncload(name,file1,calendar,var1d,var2d,vars_diurnal,date,date_diurnal)


name        = 'lasso_090615'
file2       = '%s/DADOS/lasso_sam_lsf_20150609/raw_model/sgp20150609_alpha1r.varanal_300km_25mb_ls.varanal_300km_25mb_sf.sonde_init.144.nc'%(computer)
calendar    = ["days  since 2014-12-31 00:00:00 +06:00:00",'gregorian']
...
name        = 'lasso_270615'
file3       = '%s/DADOS/lasso_sam_lsf_20150627/raw_model/sgp20150627_alpha1r.varanal_300km_25mb_ls.varanal_300km_25mb_sf.sonde_init.144.nc'%(computer)
calendar    = ["days  since 2014-12-31 00:00:00 +06:00:00",'gregorian']
...
name        = 'lasso_010815'
file4       =   '%s/DADOS/lasso_sam_lsf_20150801/raw_model/sgp20150801_alpha1r.varanal_300km_25mb_ls.varanal_300km_25mb_sf.sonde_init.144.nc'%(computer)
calendar    = ["days  since 2014-12-31 00:00:00 +06:00:00",'gregorian']
...
name        = 'lasso_290815'
file5       =   '%s/DADOS/lasso_sam_lsf_20150829/raw_model/sgp20150829_rerun2020.varanal_300km_25mb_ls.varanal_300km_25mb_sf.sonde_init.144.nc'%(computer)
calendar    = ["days  since 2014-12-31 00:00:00 +06:00:00",'gregorian']
...
name        = 'lasso_180516'
file6       =   '%s/DADOS/lasso_sam_lsf_20160518/raw_model/sgp20160518_alpha2.varanal_300km_25mb_ls.varanal_300km_25mb_sf.sonde_init.144.nc'%(computer)
...
name        = 'lasso_300516'
file7       =   '%s/DADOS/lasso_sam_lsf_20160530/raw_model/sgp20160530_alpha2.varanal_300km_25mb_ls.varanal_300km_25mb_sf.sonde_init.144.nc'%(computer)
calendar    = ["days  since 2015-12-31 00:00:00 +06:00:00",'gregorian']
...
name        = 'lasso_100616'
file8       =   '%s/DADOS/lasso_sam_lsf_20160610/raw_model/sgp20160610_alpha2.varanal_300km_25mb_ls.varanal_300km_25mb_sf.sonde_init.144.nc'%(computer)
calendar    = ["days  since 2015-12-31 00:00:00 +06:00:00",'gregorian']
...
name        = 'lasso_110616'
file9       =   '%s/DADOS/lasso_sam_lsf_20160611/raw_model/sgp20160611_alpha2.varanal_300km_25mb_ls.varanal_300km_25mb_sf.sonde_init.144.nc'%(computer)
calendar    = ["days  since 2015-12-31 00:00:00 +06:00:00",'gregorian']
...
name        = 'lasso_140616'
file10      = '%s/DADOS/lasso_sam_lsf_20160614/raw_model/sgp20160614_alpha2.varanal_300km_25mb_ls.varanal_300km_25mb_sf.sonde_init.144.nc'%(computer)
calendar    = ["days  since 2015-12-31 00:00:00 +06:00:00",'gregorian']
...
name        = 'lasso_190616'
file11       =   '%s/DADOS/lasso_sam_lsf_20160619/raw_model/sgp20160619_alpha2.varanal_300km_25mb_ls.varanal_300km_25mb_sf.sonde_init.144.nc'%(computer)
calendar    = ["days  since 2015-12-31 00:00:00 +06:00:00",'gregorian']
...
name        = 'lasso_250616'
file12       =   '%s/DADOS/lasso_sam_lsf_20160625/raw_model/sgp20160625_alpha2.varanal_300km_25mb_ls.varanal_300km_25mb_sf.sonde_init.144.nc'%(computer)
calendar    = ["days  since 2015-12-31 00:00:00 +06:00:00",'gregorian']
...
name        = 'lasso_160716'
file13      =   '%s/DADOS/lasso_sam_lsf_20160716/raw_model/sgp20160716_alpha2.varanal_300km_25mb_ls.varanal_300km_25mb_sf.sonde_init.144.nc'%(computer)
calendar    = ["days  since 2015-12-31 00:00:00 +06:00:00",'gregorian']
...
name        = 'lasso_190716'
file14      =   '%s/DADOS/lasso_sam_lsf_20160719/raw_model/sgp20160719_alpha2.varanal_300km_25mb_ls.varanal_300km_25mb_sf.sonde_init.144.nc'%(computer)
calendar    = ["days  since 2015-12-31 00:00:00 +06:00:00",'gregorian']
...
name        = 'lasso_200716'
file15      =   '%s/DADOS/lasso_sam_lsf_20160720/raw_model/sgp20160720_alpha2.varanal_300km_25mb_ls.varanal_300km_25mb_sf.sonde_init.144.nc'%(computer)
calendar    = ["days  since 2015-12-31 00:00:00 +06:00:00",'gregorian']
...
name        = 'lasso_180816'
file16      =   '%s/DADOS/lasso_sam_lsf_20160818/raw_model/sgp20160818_alpha2.varanal_300km_25mb_ls.varanal_300km_25mb_sf.sonde_init.144.nc'%(computer)
calendar    = ["days  since 2015-12-31 00:00:00 +06:00:00",'gregorian']
...
name        = 'lasso_190816'
file17      =   '%s/DADOS/lasso_sam_lsf_20160819/raw_model/sgp20160819_alpha2.varanal_300km_25mb_ls.varanal_300km_25mb_sf.sonde_init.144.nc'%(computer)
calendar    = ["days  since 2015-12-31 00:00:00 +06:00:00",'gregorian']
...
name        = 'lasso_300816'
file18      =   '%s/DADOS/lasso_sam_lsf_20160830/raw_model/sgp20160830_alpha2.varanal_300km_25mb_ls.varanal_300km_25mb_sf.sonde_init.144.nc'%(computer)
calendar    = ["days  since 2015-12-31 00:00:00 +06:00:00",'gregorian']
